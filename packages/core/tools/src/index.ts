 ...
 * The global registry (not a per-evaluation symbol) keeps one identity when
 * this module loads twice in one process — source and built copies, or two
 * loader routes — so the loop always finds the scheduler on the registry.
 * @internal
 */
