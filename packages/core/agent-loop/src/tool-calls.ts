...
import { HarnessError, createToolResultMessage, type ToolCallBlock } from '@deepseek-ai/dsh-llm'
...
export async function executeToolCalls(
  ...
  const { session } = agent
  // Fail before committing any `tool/call`: a missing scheduler slot would
  // otherwise throw a bare TypeError mid-group, stranding dangling calls.
